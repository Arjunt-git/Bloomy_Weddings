...
DATA_DIR = Path(
    os.environ.get("BLOOMY_DATA_DIR", ROOT)
)
...
def setup_database():
    ...
    with db() as connection:
        ...
        # Create default admin account if one does not exist.
...
class App(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if path == "/api/portfolio":
            return self.save_portfolio(payload)
